...
def UDP_video_sender(host, port, filename):  #https://stackoverflow.com/questions/13993514/sending-receiving-file-udp-in-python Learnt how to configure sender and reciever
        ...
        pwd=os.path.basename(filename)
        s1.sendto(pwd.encode(), addr)
...
class Client(threading.Thread):
    ...
    def handle_p2pvideo_command(self,receiver_usr, filename, recipient_ip,sender_username,sender_port,recipient_port):
